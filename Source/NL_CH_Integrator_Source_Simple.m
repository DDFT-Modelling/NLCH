function Phi_t = NL_CH_Integrator_Source_Simple(phi_ic,  aBox, Diff, Ind,  Conv, Conv_D, dF, ddF, mu_tilde, g_tilde, TimeLine, Tmin )
...
if nargin <= 11
  Tmin = 0.0;
    ...
    opts = odeset('RelTol',10^-7,'AbsTol',10^-7,'Stats','on', 'Mass',diag(mM),'Vectorized','on');
